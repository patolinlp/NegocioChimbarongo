class TipoProductosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_producto.save
        format.html { redirect_to @tipo_producto, notice: 'El Tipo de producto ha sido creado con exito.' }
  ...
  def update
    respond_to do |format|
      if @tipo_producto.update(tipo_producto_params)
        format.html { redirect_to @tipo_producto, notice: 'El Tipo de producto ha sido modificado con exito.' }
  ...
  private
    ...
    def tipo_producto_params
      params.require(:tipo_producto).permit(:nombre)
    end
end
