...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { cantidad: @articulo.cantidad, producto_id: @articulo.producto_id, venta_id: @articulo.venta_id }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { cantidad: @articulo.cantidad, producto_id: @articulo.producto_id, venta_id: @articulo.venta_id }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
