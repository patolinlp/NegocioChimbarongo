...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codigo: @producto.codigo, nombre: @producto.nombre, stock: @producto.stock, tipo_producto: @producto.tipo_producto, valor: @producto.valor }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { codigo: @producto.codigo, nombre: @producto.nombre, stock: @producto.stock, tipo_producto: @producto.tipo_producto, valor: @producto.valor }
    assert_redirected_to producto_path(assigns(:producto))
  end
